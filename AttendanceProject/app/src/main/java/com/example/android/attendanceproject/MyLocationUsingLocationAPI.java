...
/**
 * Created by Abhishek on 10/28/2017.
 */
...
import com.example.android.attendanceproject.LocationUtil.PermissionUtils;
import com.example.android.attendanceproject.LocationUtil.PermissionUtils.PermissionResultCallback;
...
public class MyLocationUsingLocationAPI extends AppCompatActivity implements ConnectionCallbacks,
    ...
    public void getAddress()
    {
        ...
        if(locationAddress!=null)
        {
            ...
            myRef = database.getReference("Abhishek").child("Latitude");
            myRef.setValue(locationAddress.getLatitude());
            myRef = database.getReference("Abhishek").child("Longitude");
            myRef.setValue(locationAddress.getLongitude());
