package com.ict.genesis.locationproject;
    ...
    public void toggleGPSUpdates(View view) {
        ...
        if (button.getText().equals("Pause")) {
            ...
            locationManager.requestLocationUpdates(
                    LocationManager.NETWORK_PROVIDER, 0, 5, locationListenerNetwork);
    ...
    public void toggleBestUpdates(View view) {
        ...
        if (button.getText().equals("Pause")) {
            ...
            if (provider != null) {
                ...
                locationManager.requestLocationUpdates(provider, 0, 5, locationListenerBest);
                button.setText("Pause");
